...
The quantitative workflow at HIP depends on three external systems: R, Github, and Box. Here are some step-by-step guides to help get you set up, whether you've just joined our team or setting up a new machine.
...
Once you're done setting up, head over to the [Using Github](using-github.qmd) page to read about why and how we use Github, and try the practice exercise at the end of that page.
